...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class ForwardRendererDataEditor : ScriptableRendererDataEditor
    {
        private static class Styles
        {
            ...
            public static readonly GUIContent TerrainMask = new GUIContent("Terrain Layer Mask", "Controls which opaque layers this renderer draws.");
        ...
        SerializedProperty m_TerrainLayerMask;
        ...
        private void OnEnable()
        {
            ...
            m_TerrainLayerMask = serializedObject.FindProperty("m_TerrainLayerMask");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_TerrainLayerMask, Styles.TerrainMask);
