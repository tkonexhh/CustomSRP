...
namespace UnityEngine.Rendering.Universal.Internal
{
    public class DrawTransparentPass : ScriptableRenderPass
    {
        ...
        public DrawTransparentPass(RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask, StencilState stencilState, int stencilReference)
        {
            base.profilingSampler = new ProfilingSampler(nameof(DrawTransparentPass));

            m_ProfilingSampler = new ProfilingSampler("DrawTransparentObjects");
