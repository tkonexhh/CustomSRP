...
namespace UnityEngine.Rendering.Universal.Internal
{
    public class DrawOpaquePass : ScriptableRenderPass
    {
        ...
        public DrawOpaquePass(RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask, StencilState stencilState, int stencilReference)
        {
            base.profilingSampler = new ProfilingSampler(nameof(DrawOpaquePass));

            m_ProfilingSampler = new ProfilingSampler("DrawOpaqueObjects");
