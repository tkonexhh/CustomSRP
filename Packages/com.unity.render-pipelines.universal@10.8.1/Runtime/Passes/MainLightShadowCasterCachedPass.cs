...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    /// </summary>
    public class MainLightShadowCasterCachedPass : ScriptableRenderPass
    {
        ...
        public bool Setup(ref RenderingData renderingData)
        {
            ...
            for (int cascadeIndex = 0; cascadeIndex < m_ShadowCasterCascadesCount; ++cascadeIndex)
            {
                ...
                out SplitData, out m_CascadeSlices[cascadeIndex], out m_CascadeSlices[cascadeIndex].viewMatrix, out m_CascadeSlices[cascadeIndex].projectionMatrix);

                if (!success)
                    return false;

                if (m_FirstFrame || (current & mask) != 0)
                    m_CascadeSplitDistances[cascadeIndex] = SplitData;
            }
            //!modify

            //!modify
            if (m_MainLightShadowmapTexture == null || m_MainLightShadowmapTexture.width != m_ShadowmapWidth || m_MainLightShadowmapTexture.height != m_ShadowmapHeight)
            {
                ...
                Debug.LogError("Create Shadowmap texture");
        ...
        //!modify
        void RenderShadowSlice(CommandBuffer cmd, ref ScriptableRenderContext context,
